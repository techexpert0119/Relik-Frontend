...
const TikTokLinkForm = () => {
  ...
  useEffect(() => {
    if (options?.featureId) {
      ...
      if (feature) {
        form.reset({
          link: feature.values.tikTokValues?.link,
          title: feature.values.tikTokValues?.title,
        });
      }
    }
